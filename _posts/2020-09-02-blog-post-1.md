...
<p style="line-height:1.5">After some searching, I came upon a document showing how changes could be made to the ODS LaTeX tagsets code: (https://support.sas.com/resources/papers/proceedings14/2033-2014.pdf).
...
I went on to download the original LaTeX tagsets code from (https://support.sas.com/rnd/base/ods/odsmarkup/latex.html#disc) (click on four LaTeX tagsets hyperlink). </p>
